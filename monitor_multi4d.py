...
# LUBADA mitme samanimelise teenuse kirjutamist nagiosele tabelisse eri ajamarkidega!
...
while 1:
    ...
    try: # kas on infot udp sisendpuhvris, ootame timeout vorra mis alguses defineeritud. kui ei ole, saatma!
        ...
        if "id:" in data:
            ...
            print "\nfrom controller",id, t, NEWSOCKET,"in",inn  #addr   # got the data, start printing lines content
